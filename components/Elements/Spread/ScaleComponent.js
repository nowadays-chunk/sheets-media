...
const ScaleComponent = (props) => {
  ...
  return (
    <Root>
      <Meta
        title={title}
        description={description || "Explore guitar scales and modes on the fretboard. Learn scale patterns, modes, and positions using the CAGED system for better guitar playing."}></Meta>
