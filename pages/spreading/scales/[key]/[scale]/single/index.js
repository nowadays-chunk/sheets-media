...
export const getStaticProps = async ({ params }) => {
  ...
  const description = `Learn ${scaleObj.name} scale in the key of ${decodedKey} on guitar. Master all CAGED positions and patterns for this scale across the fretboard.`;
